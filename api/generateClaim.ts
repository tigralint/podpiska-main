...
6. Текст должен содержать 4-5 отдельных абзацев:
   - Вступление: кто я, когда и на что подписался.
   - Факты: что произошло, почему хочу вернуть деньги, подробности ситуации.
   - Правовое обоснование: ссылки на конкретные статьи закона и их суть.
   - Требования: чётко сформулировать, чего именно требую (возврат суммы, сроки).
   - Заключение: предупреждение о последствиях (жалоба в Роспотребнадзор, суд) или вежливое завершение.
...
6. Текст должен содержать 4-5 отдельных абзацев:
   - Вступление: когда и какой договор был заключён, стоимость обучения.
   - Факты: сколько пройдено, почему решил(а) расторгнуть, конкретные претензии к качеству или формату.
   - Правовое обоснование: ссылки на ст. 32 ЗоЗПП, расчёт суммы к возврату.
   - Требования: точная сумма возврата ${refund} руб., срок 10 дней, реквизиты.
   - Заключение: предупреждение о последствиях или вежливое завершение.
7. Каждый абзац — не менее 2-3 предложений. Общий объём — минимум 200 слов.
