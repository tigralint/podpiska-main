      ...
      <div className="relative z-20 w-full text-center md:text-left md:flex justify-between items-center mb-16 mt-8 md:mt-0 opacity-0 animate-slide-up" style={{ animationDelay: '50ms' }}>
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-[1.1] text-white">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-cyan via-accent-blue to-accent-purple animate-gradient-x text-glow-cyan">{APP_CONTENT.hero.titleHighlight}</span>
          </h1>
                ...
                {searchResults.length > 0 ? (
                  ...
                  <div className="p-8 text-center animate-fade-in">
                    ...
                    <button
                      ...
                      className="px-8 py-4 bg-button-glow text-app-bg rounded-2xl font-bold shadow-[0_0_20px_rgba(0,242,254,0.3)] hover:shadow-[0_0_40px_rgba(0,242,254,0.6)] transition-all inline-flex items-center gap-2 active:scale-95 hover:scale-[1.02]"
                    >
